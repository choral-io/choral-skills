...
Supported root `AGENTS.md` workflow-block configuration:
...
For configuration questions, answer from current manifest, root workflow block, and workflow baseline.
...
- <knowledge_dir>/.workflow/manifest.yml
- root AGENTS.md -> Knowledge Workflow block
- relevant workflow baseline or skill reference

## Effective Configuration

<merged rule or field value from manifest + workflow block + prompt when applicable>
...
- manifest found
- AGENTS marked block found when needed
