...
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------ |
| `knowledge-workflow-admin` | Use when a maintainer explicitly needs Knowledge Workflow setup, checks, manifest work, or approved configuration updates.                                         | Maintainer         |
| `knowledge-assistant`      | Use when a user asks how to use Knowledge Workflow in a repository, where content belongs, which skill applies, what project rules mean, or how to recover safely. | Team, read-only    |
